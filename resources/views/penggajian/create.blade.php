...
<head>
    ...
    <style>
        ...
        /* Styling Sidebar & Topbar (Sama dengan Index) */
    ...
    <div class="d-flex">
        ...
        <div class="sidebar" style="width: 250px;">
            ...
            <ul class="sidebar-menu">
                ...
                <li><a href="{{ route('penggajian.index') }}" class="active"><i class="fas fa-table"></i> Data Penggajian</a></li>
            </ul>
        </div>
        ...
        <div class="flex-grow-1">
            ...
            <div class="content-wrapper">
                <h4 class="mb-4 text-secondary">Tambah Data Gaji</h4>
                ...
                <div class="card p-4 col-lg-8">
                    <form action="{{ route('penggajian.store') }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <select name="karyawan_id" class="form-select" required>
                                    <option value="" disabled selected>-- Pilih Data Karyawan --</option>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="input-group">
                                <span class="input-group-text">Rp</span>
                                <input type="number" name="tunjangan" class="form-control" placeholder="0" required>
                            </div>
                        </div>
